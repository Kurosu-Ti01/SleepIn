...
/**
 * Fallback palette used when dynamic color is unavailable or disabled by the user.
 *
 * Full Material 3 tonal palette generated from a blue seed (Material Theme Builder,
 * seed ≈ #4A90D9). Every color role is defined for both light and dark schemes so the
 * fallback theme never mixes with the purple M3 baseline defaults.
 *
 * Naming follows the Material Theme Builder convention: <role><Light|Dark>.
 */
